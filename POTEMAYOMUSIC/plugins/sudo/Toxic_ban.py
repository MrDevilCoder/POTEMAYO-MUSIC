import requests
import random
from POTEMAYOMUSIC import app, userbot
from POTEMAYOMUSIC.misc import SUDOERS
from pyrogram import * 
from pyrogram.types import *
from POTEMAYOMUSIC.utils.Toxic_ban import admin_filter
...
@app.on_message(filters.command(["Toxic", "baby"], prefixes=["b", "B"]) & admin_filter)
